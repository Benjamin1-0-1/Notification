...
SECRET_KEY = 'django-insecure-s2$ruhf&#04hhmic6@ww0p+==9mz7==v6=6s9enpd@v#k_h%*u'
...
# Email configuration
# Use the console backend by default for safe local development, and allow environment
# variables to override with a real SMTP provider when deploying.
